## proj.dir <- "~/RTM"
new.out.dir <- "/project/pandemic_flu/Wuhan_Coronavirus/real-time-mcmc/model_runs/20201115/NoPrev_relax_shortsero_cm4_ifr_60cutoff_matrices_20201115_deaths"
